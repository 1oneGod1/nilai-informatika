    ...
    <section class="mb-6 rounded-2xl border border-cyan-400/25 bg-gradient-to-br from-cyan-500/10 via-slate-900/70 to-violet-500/10 overflow-hidden">
      <div class="p-5 md:p-6 flex flex-col md:flex-row md:items-center gap-5">
        ...
        <div class="flex-1">
          ...
          <p class="text-sm text-slate-300 mt-1 max-w-2xl">Complete four interactive sections, submit two locked post-tests, then continue to an individual summative redesign in Figma.</p>
          <div class="flex flex-wrap gap-2 mt-3 text-[11px] font-mono-tech">
            ...
            <span class="text-pink-300"><i class="fas fa-user-pen mr-1"></i>Summative · Individual Redesign</span>
          </div>
        </div>
